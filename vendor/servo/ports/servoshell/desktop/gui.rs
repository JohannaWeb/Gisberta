...
use egui::{
    Button, Color32, Frame, Id, Key, Label, LayerId, Modifiers, Order, PaintCallback, RichText,
    Stroke, TopBottomPanel, Vec2, WidgetInfo, WidgetType, pos2,
};
...
impl Gui {
    pub(crate) fn new(
        ...
        Self::apply_gisberta_style(&context.egui_ctx);
    ...
    fn apply_gisberta_style(ctx: &egui::Context) {
        ctx.style_mut(|style| {
            let visuals = &mut style.visuals;
            visuals.window_fill = Color32::from_rgb(255, 244, 249);
            visuals.panel_fill = Color32::from_rgb(255, 236, 244);
            visuals.extreme_bg_color = Color32::from_rgb(255, 250, 252);
            visuals.faint_bg_color = Color32::from_rgb(248, 215, 227);
            visuals.code_bg_color = Color32::from_rgb(255, 232, 241);
            visuals.selection.bg_fill = Color32::from_rgb(229, 121, 165);
            visuals.selection.stroke.color = Color32::from_rgb(74, 33, 53);
            visuals.hyperlink_color = Color32::from_rgb(176, 61, 111);
            visuals.widgets.noninteractive.bg_fill = Color32::from_rgb(255, 240, 246);
            visuals.widgets.noninteractive.weak_bg_fill = Color32::from_rgb(255, 233, 241);
            visuals.widgets.inactive.bg_fill = Color32::from_rgb(255, 230, 239);
            visuals.widgets.inactive.weak_bg_fill = Color32::from_rgb(255, 223, 235);
            visuals.widgets.hovered.bg_fill = Color32::from_rgb(249, 198, 216);
            visuals.widgets.hovered.weak_bg_fill = Color32::from_rgb(246, 188, 209);
            visuals.widgets.active.bg_fill = Color32::from_rgb(234, 156, 189);
            visuals.widgets.active.weak_bg_fill = Color32::from_rgb(234, 156, 189);
            visuals.widgets.open.bg_fill = Color32::from_rgb(255, 223, 235);
            visuals.widgets.noninteractive.bg_stroke =
                Stroke::new(1.0, Color32::from_rgb(232, 184, 202));
            visuals.widgets.inactive.bg_stroke = Stroke::new(1.0, Color32::from_rgb(224, 167, 188));
            visuals.widgets.hovered.bg_stroke = Stroke::new(1.0, Color32::from_rgb(212, 130, 164));
            visuals.widgets.active.bg_stroke = Stroke::new(1.0, Color32::from_rgb(184, 81, 126));
            visuals.widgets.noninteractive.fg_stroke.color = Color32::from_rgb(99, 48, 70);
            visuals.widgets.inactive.fg_stroke.color = Color32::from_rgb(99, 48, 70);
            visuals.widgets.hovered.fg_stroke.color = Color32::from_rgb(84, 35, 57);
            visuals.widgets.active.fg_stroke.color = Color32::from_rgb(66, 26, 45);
        });
    }
        ...
        context.run(winit_window, |ctx| {
            ...
            if winit_window.fullscreen().is_none() {
                let frame = Frame::default()
                    ...
                    .stroke(Stroke::new(1.0, Color32::from_rgb(240, 201, 217)))
                    .inner_margin(4.0);
                    ...
                    ui.allocate_ui_with_layout(
                        ...
                        |ui| {
                            let badge = Frame::default()
                                .fill(Color32::from_rgb(255, 221, 233))
                                .stroke(Stroke::new(1.0, Color32::from_rgb(226, 151, 182)))
                                .corner_radius(8)
                                .inner_margin(egui::Margin::symmetric(10, 6));
                            badge.show(ui, |ui| {
                                ui.label(
                                    RichText::new("Gisberta")
                                        .strong()
                                        .color(Color32::from_rgb(104, 34, 63)),
                                );
                            });
                            ui.add_space(6.0);
                ...
                TopBottomPanel::top("tabs")
                    .frame(
                        Frame::default()
                            .fill(Color32::from_rgb(255, 242, 247))
                            .stroke(Stroke::new(1.0, Color32::from_rgb(241, 206, 220))),
                    )
                    .show(ctx, |ui| {
                        ui.allocate_ui_with_layout(
                            ui.available_size(),
