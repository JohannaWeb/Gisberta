...
pub(crate) const INITIAL_WINDOW_TITLE: &str = "Gisberta";
...
impl HeadedWindow {
    pub(crate) fn new(
        ...
        #[cfg(target_os = "linux")]
        let window_attr = window_attr.with_name("org.gisberta.Browser", "Gisberta");
...
impl PlatformWindow for HeadedWindow {
    ...
    fn update_user_interface_state(&self, _: &RunningAppState, window: &ServoShellWindow) -> bool {
        ...
        let title = if page_title.is_empty() {
            ...
            format!("{page_title} • {INITIAL_WINDOW_TITLE}")
        };
