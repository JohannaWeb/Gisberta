...
#[bpaf(options, version(VERSION), usage("gisberta [OPTIONS] URL"))]
...
struct CmdArgs {
    ...
    #[bpaf(positional("URL"), fallback(String::from("servo:newtab")))]
    url: String,
}
